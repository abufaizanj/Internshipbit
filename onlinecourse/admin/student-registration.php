...
$upincode = rand(100000,999999);
$ret=mysqli_query($con,"insert into students(studentName,StudentRegno,password,upincode) values('$studentname','$studentregno','$password','$upincode')");
if($ret)
{
echo '<script>alert("Student Registered Successfully. Upincode is "+"'.$upincode.'")</script>';
