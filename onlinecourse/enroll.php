...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,upincode,session,department,level,course,semester) values('$studentregno','$upincode','$session','$dept','$level','$course','$sem')");
if($ret)
{
...
<div class="form-group">
    <label for="Upincode">Upincode  </label>
    <input type="text" class="form-control" id="Upincode" name="Upincode" readonly value="<?php echo htmlentities($row['upincode']);?>" required />
  </div>   

<div class="form-group">
    <label for="Upincode">Student Photo  </label>
