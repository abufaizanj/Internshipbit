...
INSERT INTO `courseenrolls` (`id`, `studentRegno`, `upincode`, `session`, `department`, `level`, `semester`, `course`, `enrollDate`) VALUES
...
INSERT INTO `students` (`StudentRegno`, `studentPhoto`, `password`, `studentName`, `upincode`, `session`, `department`, `semester`, `cgpa`, `creationdate`, `updationDate`) VALUES
